...
from prometheus.models import AnalysisResult, Severity
...
"""
        ...
        html += f"""
        <footer>
            <p>Generated by Prometheus | {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}</p>
...
"""
        ...
        md += f"\n---\n\n*Report generated by Prometheus*"
